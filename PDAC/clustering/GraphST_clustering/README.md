...
Then, information about spots spatial locations (G) and expression profiles (X and X') are learned using a Graph Neural Network encoder to integrate insights about neighborhood spots, resulting in latent representation matrixes Z<sub>s and Z'<sub>s<sub>, depending on the normalized matrix used in input.
