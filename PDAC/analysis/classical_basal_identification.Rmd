...
```
## Filtering based on specific markers
```{r}
...
sprr1b_pos <- colnames(normalized_data@assays$Spatial["counts"])[normalized_data@assays$Spatial["counts"]["SPRR1B", ] > 5]

scel_pos <- colnames(normalized_data@assays$Spatial["counts"])[normalized_data@assays$Spatial["counts"]["SCEL", ] > 3]

sprr3_pos <- colnames(normalized_data@assays$Spatial["counts"])[normalized_data@assays$Spatial["counts"]["SPRR3", ] > 5]

krt6a_pos <- colnames(normalized_data@assays$Spatial["counts"])[normalized_data@assays$Spatial["counts"]["KRT6A", ] > 21]

fam83a_pos <- colnames(normalized_data@assays$Spatial["counts"])[normalized_data@assays$Spatial["counts"]["FAM83A", ] > 7]
```