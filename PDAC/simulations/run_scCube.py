...
sc_adata = sc.read("../results/sptype/Visium_FFPE_V43T08-041_D_sctype.h5ad")
coordinates = pd.read_csv("../../datashare/visium_PDAC/Visium_FFPE_V43T08-041_D/outs/spatial/tissue_positions.csv")
